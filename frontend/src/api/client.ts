...
export const clientsApi = {
  ...
  create: (dto: Omit<Client, 'id'>) =>
    api<Client>('/clients', { method: 'POST', body: JSON.stringify(dto) }),
  update: (id: string, dto: Partial<Omit<Client, 'id'>>) =>
    api<Client>(`/clients/${id}`, { method: 'PUT', body: JSON.stringify(dto) }),
  delete: (id: string) => api(`/clients/${id}`, { method: 'DELETE' }),
};

export const companySettingsApi = {
  get: () => api<CompanySettings | null>('/company-settings'),
  upsert: (dto: Omit<CompanySettings, 'id'>) =>
    api<CompanySettings>('/company-settings', { method: 'PUT', body: JSON.stringify(dto) }),
};
...
export const invoicesApi = {
  ...
  create: (dto: CreateInvoicePayload) =>
    api<Invoice>('/invoices', { method: 'POST', body: JSON.stringify(dto) }),
  update: (id: string, dto: CreateInvoicePayload) =>
    api<Invoice>(`/invoices/${id}`, { method: 'PUT', body: JSON.stringify(dto) }),
